...
Now we can talk about the presheaf category $\text{PSh}(Sm/S)$ and the sheaf category $\text{Shv}_{Nis}(Sm/S)$ with respect to the Nisnevich topology. The sheaficiation can be viewed as a $S$-localization, thus admits a left adjoint sheaficiation functor $L_{Nis}:\text{PSh}(Sm/S) \to \text{Shv}_{Nis}(Sm/S)$.
...
\begin{definition}
    Let $S$ be a Noethrian scheme. We define the unstable motivic homotopy category $\mathcal{H}(S)$ as the S-localization of $\text{PSh}(Sm/S)$, where $S$ is the set of morphisms generated by:

    1. $\{\mathcal{F}\times \mathbb{A}^1 \to \mathcal{F}|\mathcal{F}\in \text{PSh}(Sm/S)\}$;

    2. $\{\check{C}(\mathcal{U}) \rightarrow X\}$.
\end{definition}
